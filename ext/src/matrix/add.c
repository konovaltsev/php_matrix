...
PHP_FUNCTION(matrix_add_int)
{
    ...
    php_matrix_scalar_function(return_value, arg_matrix1, arg_matrix2, &php_array_add_sum_int);
}
...
PHP_FUNCTION(matrix_add_float)
{
    ...
    php_matrix_scalar_function(return_value, arg_matrix1, arg_matrix2, &php_array_add_sum_double);
}
